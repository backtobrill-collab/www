...
if ($is_local) {
	...
	// HTTP
	define('HTTP_SERVER', $catalog_url);

	// HTTPS
	define('HTTPS_SERVER', $catalog_url);
	...
	// HTTP
	define('HTTP_SERVER', 'https://don-fish.com/');

	// HTTPS
	define('HTTPS_SERVER', 'https://don-fish.com/');

	// DIR
	define('DIR_APPLICATION', '/var/www/u1805311/data/www/don-fish.com/catalog/');
